...
<html lang="en">
    ...
    <head>
        ...
        <title>F.E.M - Club Event Page</title>
        <!-- Favicon icon -->
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                        <img src="images/profile/resize/3.jpg" width="20" alt="" />
                    ...
                    <div class="d-flex flex-wrap mb-2 align-items-center justify-content-between">
                        ...
                        <div class="event-tabs mb-3 mr-3">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="MainController?action=ListEvent" role="tab"
                                       aria-selected="true">
                                        All
                                    </a>
                                </li>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <a href="javascript:void(0)" class="btn btn-primary text-nowrap">
                                <i class="fa fa-file-text scale5 mr-3" aria-hidden="true">
                                        ...
                                        <table id="example2" class="table card-table display dataTablesCard">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="<%=listEvent.get(i).getImgUrl()%>" target="_blank">Click</a></td>
