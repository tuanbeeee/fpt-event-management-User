...
<html lang="en" >
    <head>
        <meta charset="UTF-8">
        <title>Create An Event - FPT Event Management</title> 
        <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'>
        <link rel="stylesheet" href="./css_FormCreate/css/style.css">
    ...
    <body>
        ...
        <div class="container">
            <form action="MainController" method="POST">
                ...
                <div class=" btn btn-danger" style="text-align: center">
                    <a href="EventListController">Cancel</a>
                </div>
        ...
        <!-- partial -->
        <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script><script  src="./css_FormCreate/js/script.js"></script>
